...
func bindRouterV1(v1 *gin.RouterGroup) {
	...
	v1.POST("/pscc/:business_id/add/park/", addParkV1)           //添加园区
	v1.POST("/pscc/:business_id/edit/park/:park_id", editParkV1) //编辑园区
	v1.GET("/pscc/:business_id/del/park/:park_id", delParkV1)    //删除园区
}
